...
//picArray has two images for each item: medium and large. Medium is used in the <img> inside
// the <article> and large is used in the <img> inside the <dialog>.
...
let picElements = document.getElementById('pictures');
...
<p>${picArray[i].description}</p>`
  ...
  article.addEventListener('click', () => {
    ...
    dialogImage.src = picArray[i].image.large;
  })

  picElements.appendChild(article);
}
